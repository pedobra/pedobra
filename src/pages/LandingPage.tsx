            ...
            <header className="hero-section text-center">
                <div className="section-container">
                    ...
                    <h1 className="hero-title animate-fade">
                        ...
                        menos <span className="text-glow highlight-accent">DINHEIRO</span> <br />
                                ...
                                <div key={i} className={`plan-card glass ${p.highlight ? 'plan-highlight' : ''}`}>
                                    ...
                                    <button className={`plan-btn ${p.highlight ? 'highlight-glow' : ''}`} onClick={() => {
                                        if (p.isCustom) {
                                            ...
                                            window.open("https://pay.cakto.com.br/9i8zorr_821104", "_blank");
                                        } else if (p.name === "Plano Profissional") {
                                            window.open("https://pay.cakto.com.br/aokxun4_821086", "_blank");
                                        } else {
                                            setIsSignUp(true);
                                        }
