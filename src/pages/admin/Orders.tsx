    ...
    return (
        <div className="orders-view">
            ...
            <style>{`
                ...
                .ref-badge { font-family: monospace; background: rgba(255,255,255,0.05); padding: 4px 8px; border-radius: 6px; color: var(--primary); font-weight: 700; border: 1px solid var(--border); }
